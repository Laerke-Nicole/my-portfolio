...
const getPortfolio = () => {
    const state = ref([
        {
            id: 'product-one',
            image: 'https://firebasestorage.googleapis.com/v0/b/laerke-nicole-portfolio.appspot.com/o/projects%2Fwebsite-kanten.jpg?alt=media&token=cf697d20-bd17-4b7a-8686-48320752b808&_gl=1*15ydar0*_ga*MTk3MzI2MTY1LjE2ODIwNzA2MjE.*_ga_CW55HF8NVT*MTY4NTgxMDI3NC40My4xLjE2ODU4MTA0NDMuMC4wLjA.',
